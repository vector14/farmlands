        ...
        <script type="text/javascript">
            ...
            function drawVisualization() {
                ...
                var data = google.visualization.arrayToDataTable([
                    ['No.Muestra', 'Temperatura Ambiente', 'Temperatura Muestra'],
<?php
...
//            }
    ...
    <body>
        <h5 class="card-title">Grafico de ph de las ultimas 5 muestras</h5>
    ...
    <button class="btn btn-primary" id="btnConsultar">Consultar Muestra Seleccionada</button>
