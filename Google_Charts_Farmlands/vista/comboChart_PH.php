...
$limite = $_POST["limite"];
$sql = "SELECT id_muestra, ph FROM muestra_prueba order by id_muestra desc LIMIT $limite";
$res = $con->query($sql);
$con->close();
?>
<html>
...
?>
                ...
                var options = {
                    title: 'Ph de las muestras de cultivo',
                    hAxis: {
                        title: 'Id de la muestra',
                        format: ' '
                    },
                    vAxis: {
                        title: 'PH'
...
<body>
    <style>
        ...
        <h5 class="card-title">Grafico de ph de las ultimas <?php echo $limite ?> muestras</h5>
