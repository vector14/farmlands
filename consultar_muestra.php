...
?>
                          ...
                          <div class="form-group">
                            ...
                            <input class="form-control" id="TEMPERATURA" name="TEMPERATURA" type="text" placeholder="TEMPERATURA"/>
                    ...
                    <div class="modal-body">                      
                       ...
                       <div class="form-group">
                       		...
                       		<div class="form-group">
                       			...
                       			<input class="form-control" id="fecha_muestra" name="fecha_muestra" type="text" /></input>
                           </div>
                           <div class="form-group">
                           ...
                           <div class="form-group">
                       			...
                       			<input class="form-control" id="ph" name="ph" type="text" /></input>
                           </div>
                           <div class="form-group">
