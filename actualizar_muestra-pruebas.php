  ...
  session_start();
	...
	$ID = $_POST['id_muestra'];
      ...
      $FECHA_MUESTRA = $_POST['FECHA_MUESTRA'];
			...
			$sql = $mysqli->query("UPDATE muestra_prueba SET PH = '$PH', TEMPERATURA_A = '$TEMPERATURA_A', TEMPERATURA_M = '$TEMPERATURA_M', HUMEDAD = '$HUMEDAD', PRESION_ATMOSFERICA = '$PRESION_ATMOSFERICA', FECHA_MUESTRA = '$FECHA_MUESTRA', COLOR_HOJA = '$COLOR_HOJA', SECCION_CULTIVO = '$SECCION_CULTIVO' WHERE ID_MUESTRA = $ID");			
