<?php
	...
	$mysqli=conectar();
      ...
      $FECHA_MUESTRA = $_GET['FECHA_MUESTRA'];
			...
			$sql = $mysqli->query("INSERT INTO muestra_prueba (ID_MUESTRA,PH, TEMPERATURA_A, TEMPERATURA_M, HUMEDAD, PRESION_ATMOSFERICA, FECHA_MUESTRA, COLOR_HOJA, SECCION_CULTIVO) 
			VALUES (NULL ,'$PH', '$TEMPERATURA_A', '$TEMPERATURA_M', '$HUMEDAD', '$PRESION_ATMOSFERICA', '$FECHA_MUESTRA', '$COLOR_HOJA', '$SECCION_CULTIVO')");			
